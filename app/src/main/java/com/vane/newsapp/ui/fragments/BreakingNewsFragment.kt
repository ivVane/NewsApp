...
import com.vane.newsapp.databinding.FragmentBreakingNewsBinding
...
class BreakingNewsFragment : Fragment(R.layout.fragment_breaking_news),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            recyclerViewBreakingNews.adapter = newsPagingAdapter.withLoadStateHeaderAndFooter(
            ...
            newsPagingAdapter.addLoadStateListener { loadState ->
                ...
                recyclerViewBreakingNews.isVisible =
